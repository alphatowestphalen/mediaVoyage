          ...
          <div className="flex items-center justify-between py-4 bg-white dark:bg-gray-800">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Recherche Occupation"
              />
            </div>
          </div>
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4">03/05/23</td>
                <td className="px-6 py-4">23/05/23</td>
                <td className="px-6 py-4">L003</td>
                <td className="px-6 py-4">
                  <div className="flex gap-6">
                    ...
                    <a
                      ...
                      type="button"
                      data-modal-show="editUserModal"
                      className="font-medium ml-8 text-red-700 dark:text-red-500 hover:underline"
                    >
                      Delete
                    </a>
                  </div>
